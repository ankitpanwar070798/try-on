    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
      <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-lg p-10 flex flex-col items-center gap-6 w-full max-w-md mx-4">
        ...
        <form onSubmit={handleEmailAuth} className="w-full flex flex-col gap-4">
          <div>
            <input
              ...
              className="border-2 border-purple-300 p-4 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
              disabled={loading}
              required
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full bg-gradient-to-r from-purple-500 to-teal-500 text-white px-6 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transform transition-all duration-200 ${
        ...
        <button
          ...
          disabled={loading}
          type="button"
          className={`w-full bg-white border-2 border-gray-300 text-gray-700 px-6 py-4 rounded-lg font-semibold shadow-md hover:shadow-lg flex items-center justify-center gap-3 transition-all duration-200 ${
            loading ? "opacity-70 cursor-not-allowed" : "hover:bg-gray-50 hover:scale-105"
          }`}
        >
